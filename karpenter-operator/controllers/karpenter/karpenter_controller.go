...
func (r *Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if hcp.DeletionTimestamp != nil {
		if controllerutil.ContainsFinalizer(hcp, karpenterFinalizer) {
			...
			if err := r.GuestClient.List(ctx, nodePoolList, client.InNamespace(r.Namespace)); err != nil {
			...
			if err := r.GuestClient.List(ctx, nodeClaimList, client.InNamespace(r.Namespace)); err != nil {
